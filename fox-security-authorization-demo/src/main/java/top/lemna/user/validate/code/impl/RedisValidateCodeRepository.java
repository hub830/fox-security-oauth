...
public class RedisValidateCodeRepository implements ValidateCodeRepository {
   ...
   * (non-Javadoc)
   * 
   * @see com.imooc.security.core.validate.code.ValidateCodeRepository#save(org.
  ...
  public void save(ServletWebRequest request, ValidateCode code, ValidateCodeType type) {
    ...
    redisTemplate.opsForValue().set(buildKey, code, 30, TimeUnit.MINUTES);
  }

  /*
   * (non-Javadoc)
   * 
   * @see com.imooc.security.core.validate.code.ValidateCodeRepository#get(org.
   * springframework.web.context.request.ServletWebRequest,
   * com.imooc.security.core.validate.code.ValidateCodeType)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.imooc.security.core.validate.code.ValidateCodeRepository#remove(org.
   * springframework.web.context.request.ServletWebRequest,
   * com.imooc.security.core.validate.code.ValidateCodeType)
   */
  @Override
