package top.lemna.security.user.validate.code.image;
...
import top.lemna.security.app.validate.code.image.ImageCode;
...
public class MyImageCodeGenerator implements ValidateCodeGenerator {
   ...
   * (non-Javadoc)
   * 
   * @see com.imooc.security.core.validate.code.ValidateCodeGenerator#generate(org.
